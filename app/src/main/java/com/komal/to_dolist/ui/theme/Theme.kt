package com.komal.to_dolist.ui.theme
...
private val DarkColorScheme = darkColorScheme(
    ...
    onPrimary = Color.Black,       // Text color on primary (gold)
...
private val LightColorScheme = lightColorScheme(
    primary = Color(0xFFC19A6B),  // Light Gold/Bronze
    secondary = Color(0xFFEED9C4), // Soft Beige
    background = Color(0xFFF5F5DC), // Cream White
    surface = Color(0xFFFFFFFF),   // Pure White
    onPrimary = Color.White,       // Text/icons on primary (gold)
    onSecondary = Color.Black,     // Text/icons on secondary (beige)
